...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/reviewer/notifications.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <style>
        /* Fix khoảng cách logo → nav giống các trang Approval khác */
        .sidebar .logo { margin-bottom: 16px; }
        .main.notifications-page { padding-top: 32px; }
    </style>
</head>
                            ...
                            <main class="main notifications-page">
                                ...
                                <div class="pending-container">
                                    ...
                                    <c:forEach var="n" items="${notifications}">
                                        <fmt:formatDate var="formattedCreatedAt" value="${n.createdAt}"
                                            ...
                                            <div class="noti-body">
                                                <div class="noti-top">
                                                    <div class="noti-title-line">
                                                        ...
                                                        <c:choose>
                                                            <c:when
                                                                test="${n.priority eq 'HIGH' || n.priority eq 'High' || n.priority eq 'CRITICAL' || n.priority eq 'Critical'}">
                                                                <span class="badge b-high">High Priority</span>
                                                            </c:when>
                                                            <c:when
                                                                test="${n.priority eq 'MEDIUM' || n.priority eq 'Medium'}">
                                                ...
                                                <div class="noti-actions">
                                                    <button type="button" class="link-action"
                                                        ...
                                                        data-priority="${n.priority}" data-type="${n.type}"
