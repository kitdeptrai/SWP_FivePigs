<%-- Document : noification Created on : Mar 5, 2026, 3:35:34 PM Author : MinhPD --%>
                    ...
                    <div class="layout">
                        ...
                        <div class="main notifications-page">
                            ...
                            <div class="noti-head">
                                ...
                                <div class="noti-head-right">
                                    <!-- Mark All Read -->
                                    <form action="${pageContext.request.contextPath}/vendor/notification" method="post">
                            ...
                            <div class="pending-container">
                                ...
                                <c:forEach var="n" items="${notifications}">
                                    <div class="noti-card notification-card" data-read="${n.read}" data-type="${n.type}"
                                        data-title="${fn:toLowerCase(n.title)}">
                                        ...
                                        <div class="noti-body">
                                            <div class="noti-top">
                                                <div class="noti-title-line">
                                                    ...
                                                    <c:choose>
                                                        <c:when
                                                            test="${n.priority eq 'High' || n.priority eq 'Critical'}">
                                                            <span class="badge b-high">High Priority</span>
                                                        </c:when>
                                                        <c:when test="${n.priority eq 'Medium'}">
                                                            <span class="badge b-med">Medium</span>
                                            ...
                                            <div class="noti-actions">
                                                ...
                                                <!-- View Details -> modal -->
                                                <button type="button" class="link-action" onclick="openDetails(
                                        '${n.notificationId}',
                                        '${fn:escapeXml(n.title)}',
                                        '${fn:escapeXml(n.content)}',
                                        '${n.priority}',
                                        ...
                                        '${n.relatedUrl}'
                                                ...
                                                <!-- Toggle Read/Unread -->
                                                <form
                                                    action="${pageContext.request.contextPath}/vendor/notification"
                                                    method="post" style="display:inline;">
...
>>>>>>> ff401f4647fd4383bf6dff377a627a9389e9a15e
