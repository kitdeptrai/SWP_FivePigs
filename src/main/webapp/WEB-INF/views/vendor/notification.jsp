...
<button class="chip" data-type="Updates">Updates</button>
                                ...
                                <div class="pending-container">
                                    ...
                                    <c:forEach var="n" items="${notifications}">
                                        <div class="noti-card notification-card" data-read="${n.read}"
                                            data-type="${n.type}" data-title="${fn:toLowerCase(n.title)}">
...
let okSearch = (q === "") ? true : title.includes(q);
                            ...
                            function openDetails(id, title, content, priority, type, time, relatedUrl) {
                                ...
                                document.getElementById("mStatus").innerText = type || "Active";
