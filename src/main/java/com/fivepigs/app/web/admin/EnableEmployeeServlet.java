...
@WebServlet("/admin/employees/enable")
public class EnableEmployeeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            resp.sendRedirect(req.getContextPath() + "/admin/employees?success=enabled");
