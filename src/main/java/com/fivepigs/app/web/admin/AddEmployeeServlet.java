...
@WebServlet("/admin/employees/create")
public class AddEmployeeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String roleName = req.getParameter("roleName"); // 'reviewer' or 'aproval'
        ...
        if (adminDao.emailExists(email)) {
            resp.sendRedirect(req.getContextPath() + "/admin/employees?error=email_exists");
            return;
        }
        ...
        try {
            ...
            String subject = "Tài khoản nhân viên FivePigs của bạn đã được tạo";
            String body = "<div style='font-family: Arial, sans-serif; line-height: 1.6;'>"
                    + "<h2>Chào mừng " + fullName + "!</h2>"
                    + "<p>Tài khoản nhân viên của bạn trên hệ thống FivePigs đã được tạo thành công.</p>"
