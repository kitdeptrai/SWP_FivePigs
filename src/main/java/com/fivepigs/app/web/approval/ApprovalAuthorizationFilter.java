...
@WebFilter(urlPatterns = {
        ...
        "/approval_profile",
        "/ApprovalErrorReports",
        "/ApprovalErrorReportDetail"
})
public class ApprovalAuthorizationFilter implements Filter {
    ...
    private boolean isApproval(User user, HttpSession session) {
        String roleName = resolveRoleName(user, session);
        if (roleName == null) return false;
        String role = roleName.trim().toLowerCase();
        return "approval".equals(role) || "aproval".equals(role);
    }
