  ...
  <div class="container">
    <div class="card">
      <div style="text-align: center; margin-bottom: 20px;">
          ...
          <p class="subtitle">Mã OTP đã được gửi đến email:<br><strong style="color: var(--text)"><c:out value="${sessionScope.reset_email}"/></strong></p>
      </div>
      ...
      <c:if test="${param.resend == 'true'}">
        <div class="alert success">Đã gửi lại mã OTP mới.</div>
      </c:if>
      ...
      <form method="post" action="${pageContext.request.contextPath}/verify-reset-otp" autocomplete="off">
        ...
        <div class="actions">
          <button type="submit" id="btn-submit" style="height: 48px; font-size: 16px;">Xác nhận tài khoản</button>
        </div>
      </form>

      <div class="resend-container">
          <a class="resend-link" href="${pageContext.request.contextPath}/forgot-password">Thay đổi email</a>
          <span style="color: var(--border)">|</span>
          <a class="resend-link" href="${pageContext.request.contextPath}/verify-reset-otp?resend=true">Gửi lại mã</a>
      </div>
    </div>
  </div>
